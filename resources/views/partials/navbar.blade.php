<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-12">
    <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">My Laravel Website</span>
      @guest
        <span class="text-gray-900 dark:text-white">Hello, Guest</span>
      @endguest
    </a>
    <div class="flex md:order-2 space-x-4 rtl:space-x-reverse">
      @auth
        <span class="text-gray-900 dark:text-white">Hello, {{Auth::user()->name}}</span>
    ...
    <div class="w-full md:block md:w-auto" id="navbar-default">
      <ul
        ...
        <li>
          <a href="job"
            class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Job</a>
        </li>
        <li>
          <a href="contact"
        ...
        <li>
          <a href="post"
            class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Post</a>
        </li>
        <li>
          <a href="comments"
            class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Comments</a>
        </li>
      </ul>
    </div>
  </div>
